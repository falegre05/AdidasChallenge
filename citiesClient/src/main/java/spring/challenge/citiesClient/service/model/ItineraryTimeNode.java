...
// Object made to get A* algorithm based on less time working with the particularity that 
// it also stores the number of connections to get to an specific city from the origin one
